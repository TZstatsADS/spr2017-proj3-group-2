...
run('C://Program Files/MATLAB/R2014b/vlfeat/toolbox/vl_setup')
conf.calDir = 'C://Users/Lloyd/Documents/GitHub/spr2017-proj3-group-2/data/' ; % calculating directory
conf.dataDir = 'C://Users/Lloyd/Documents/GitHub/spr2017-proj3-group-2/data/images/' ; % data (image) directory 
conf.outDir = 'C://Users/Lloyd/Documents/GitHub/spr2017-proj3-group-2/data/output2/'; % output directory
...
if ~exist(conf.vocabPath)
  ...
  csvwrite('C://Users/Lloyd/Documents/GitHub/spr2017-proj3-group-2/data/output2/frameSelected.csv', framesSelected);
  csvwrite('C://Users/Lloyd/Documents/GitHub/spr2017-proj3-group-2/data/output2/imgSelected.csv', imgSelected);
  % Quantize the descriptors to get the visual words
  [vocab, assign] = vl_kmeans(descrsSelected, conf.numWords, 'verbose', 'algorithm', 'elkan', 'MaxNumIterations', 100) ;
  save(conf.vocabPath, 'vocab');
  
  assign_tr = assign.';
  csvwrite('C://Users/Lloyd/Documents/GitHub/spr2017-proj3-group-2/data/output/sift_feature_assign.csv', assign_tr);
...
if ~exist(conf.histPath)
  ...
  csvwrite('C://Users/Lloyd/Documents/GitHub/spr2017-proj3-group-2/data/output2/hists_sparse_full.csv',hists_sparse);
  csvwrite('C://Users/Lloyd/Documents/GitHub/spr2017-proj3-group-2/data/output2/features.csv', hists)
