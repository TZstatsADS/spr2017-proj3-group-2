...
##source files that contain tuning functions: 
...
source
#tune for xgBoost
tune.xgb(new_train_feat1,label_train)
tune.xgb(new_train_feat2,label_train)
tune.xgb(new_train_feat3,label_train)
#tune for gbm 
bl.tune()
bl.tune()
bl.tune()
