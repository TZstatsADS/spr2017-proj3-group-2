...
if(run.test){
  ...
  tm_test_base <- system.time(pred_test_base <- test(fit_train_base, dat_test, model="base"))
  tm_test_adv <- system.time(pred_test_adv <- test(fit_train_adv, dat_test, model="advanced"))
}
