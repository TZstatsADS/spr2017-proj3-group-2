...
load("../output/summary_best_blgbm.RData") #BL model
...
#create seperate table for baseline model
summary2<- summary.bl
...
summary2<- data.table(summary2[,1], Features= "Original SIFT", summary2[,2:6]) 

(summary1 <- data.table(summary1[,1], Features = rep("Original SIFT",9), summary1[,2:6]))

save(summary1,file="../output/summary_best_models1.Rdata")
save(summary2, file="../output/summary_best_baseline_original.RData")
...
###******* Tune for gbm 
#set.seed(15)
#  1)tune on the first set of new visual features (adaptive+ resize) for the training images
#########============Uncomment Code Below============#########
summary.gbm.new1 <- tune.bl(new_train_feat1, label_train)
save(summary.gbm.new1,file="../output/summary_best_gbm_new1.Rdata")
#########============================================#########
#  2)tune on the second set of new visual features (resize) for the training images
#########============Uncomment Code Below============#########
summary.gbm.new2 <- tune.bl(new_train_feat2, label_train)
save(summary.gbm.new2,file="../output/summary_best_gbm_new2.Rdata")
#########============================================#########
#  3)tune on the third set of new visual features (adaptive) for the training images
#########============Uncomment Code Below============#########
summary.gbm.new3 <- tune.bl(new_train_feat3, label_train)
...
####Summary Table of best models tuned on various feature sets (original SIFT & new) 
```{r}
#load Rdata files 
load("../output/summary_best_models1.Rdata")
load("../output/summary_best_models2.Rdata")

summary3 <- rbind(summary1,summary2)
